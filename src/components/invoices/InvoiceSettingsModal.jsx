            ...
            <form id="settings-form" onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              ...
              <div>
                ...
                <div>
                  ...
                  <textarea rows={3} {...register('preparedBy')} className="w-full px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:border-indigo-500" placeholder="e.g. John Doe, CEO CRM SaaS Software Services LLP" />
                </div>
              </div>
